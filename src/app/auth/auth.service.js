(function () {
    ...
    /** @ngInject */
    function authService($location, $http, $q, localStorageService, authSettings, configService) {
        ...
        function changeBackend(backend) {
            serviceBase = 'http://' + backend.hostname + ':' + backend.port;
